...
human_specs <- cols(
  ...
  `ModulesCompleted` = col_character(),
...
test_specs <- cols(
  ...
  GAINS4_TestID = col_double(),
  GAINS4_SpecimenID = col_double(),
  Country = col_character(),
  TestBatchName = col_character(),
  IsOutbreakTesting = col_character(),
  SiteName = col_character(),
  ConcurrentSamplingSite = col_character(),
  District = col_character(),
  StateProv = col_character(),
  ...
  SpeciesScientificName = col_character(),
  SpeciesEnglishName = col_character(),
  AnimalSampleDate = col_date(format = ""),
  Sex = col_character(),
  SpecimenID = col_character(),
  SpecimenType = col_character(),
  TestName = col_character(),
  LabSubmissionDate = col_date(format = ""),
  TestDate = col_date(format = ""),
  ResultsDate = col_date(format = ""),
  LabName = col_character(),
  TestType = col_character(),
  TestRequested = col_character(),
  TestRequestedProtocol = col_character(),
  MethodologyReference = col_character(),
  TestResult = col_character(),
  RealTime_PositiveControlValue1 = col_character(),
  RealTime_PositiveControlValue2 = col_character(),
  RealTime_InternalControlValue = col_character(),
  RealTime_CTValue = col_character(),
  ConfirmationTestType = col_character(),
  LabName_Confirmation = col_character(),
  ConfirmationTestDate = col_date(format = ""),
  ConfirmationResult = col_character(),
  Sequence = col_character(),
  Virus = col_character(),
  TestStatus = col_character(),
  Notes = col_character(),
  ConfirmationNotes = col_character(),
  GovernmentReport = col_character(),
  DateGovtApprovedRelease = col_date(format = "")
)
...
humanzoo_specs  <- c()
animalproduction_specs  <- c()
cropproduction_specs  <- c()
dwellings_specs  <- c()
extractiveindustry_specs  <- c()
marketvaluechain_specs  <- c()
naturalareas_specs  <- c()
wildliferestaurant_specs  <- c()
zoosanctuary_specs  <- c()
