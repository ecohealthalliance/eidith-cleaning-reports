...
for (i in seq_along(tables)){
  ...
  create_unique_table(tab, module = tab_name, metanames, cols_to_ignore = c("Notes", "Comment", "SiteName", "ID", "EventName", "^Class$", "^Order$", "^Family$", "^Genus$", "Species", "Latitude", "Longitude")) %>% print()
  cat("</details>")
  cat('\n')
}
```
...
markup <- map(seq_along(tables), function(i){
  ...
  empty_index <- get_empty(tab, module = tab_name, metanames, cols_to_ignore = c("Notes", "Comment", "^Class$", "^Order$", "^Family$", "^Genus$", "Species", "OutbreakName"))
